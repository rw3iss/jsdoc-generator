import {
  ...
  EnumDeclaration, ExpressionWithTypeArguments, getTextOfJSDocComment, HeritageClause, InterfaceDeclaration,
  MethodDeclaration, ModifiersArray, Node, NodeArray, ParameterDeclaration,
  PropertyDeclaration, SyntaxKind, TypeAliasDeclaration, TypeNode, TypeParameterDeclaration, VariableDeclaration
} from 'typescript';
